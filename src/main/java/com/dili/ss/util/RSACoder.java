...
//        String data = RSACoder.desEncrypt(str, null, "12345678");
//        System.out.println("加密后:"+data);
//        data = RSACoder.desDecrypt(data, null, "12345678");
//        System.out.println("解密后:"+data);
        //乙方使用公钥对数据进行加密
//        byte[] code2 = RSACoder.encryptByPublicKey(str.getBytes(), Base64.decodeBase64(publicKeyStr));
...
//
//        //甲方使用私钥对数据进行解密
//        byte[] decode2 = RSACoder.decryptByPrivateKey(code2, Base64.decodeBase64(privateKeyStr));
